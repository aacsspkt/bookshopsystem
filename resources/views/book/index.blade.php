            ...
            <div class="bg-white shadow-md rounded mx-6 sm:mx-3  py-4 px-6">
                <div class="mb-2 flex">
                    ...
                    <a href="{{ route('books.create') }}"
                        class="inline-flex justify-center items-center ml-6 md:ml-12 hover:shadow-md mr-auto  py-1.5 px-4 md:w-20 rounded bg-blue-400 text-white">New</a>
                </div>
                ...
                <div class="mb-2 md:my-4">
                    <table class="table-auto min-w-full">
                        ...
                        <tbody>
                            ...
                            <tr class="text-gray-500 font-light text-sm border-b flex flex-col py-1 md:table-row hover:bg-slate-100"
                                ondblclick="showBookDetail({{ $book->id }})">
                                ...
                                <td class="flex md:py-2 md:table-cell overflow-hidden">
                                    <span class="w-2/5 md:hidden">
                                        Author
                                    </span>
                                    {{ $book->firstname . ' ' . $book->surname }}
                                </td>
                                <td class="flex md:py-2 md:table-cell overflow-hidden">
                                ...
                                <td class="md:py-1 md:table-cell overflow-hidden">
                                    <a class="inline-block bg-amber-400 rounded p-1 hover:shadow-lg"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 stroke-white opacity-50"
